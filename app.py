...
def main():
    ...
    st.markdown("Are your mushrooms edible or poisonous?𓍊")
    st.sidebar.markdown("Are your mushrooms edible or poisonous?𓍊")
    ...
    if classifier=="Logistic Regression":
        ...
        max_iter = st.sidebar.slider("Maximum Number of Iterations", 100, 500, key='max_depth')
    ...
    if classifier=="Random Forest":
        ...
        max_depth = st.sidebar.number_input("Maximum depth of tree", 1, 20, key='max_iter')
        bootstrap = st.sidebar.radio("Bootstrap samples when building",('True','False'),key='bootstrap')
